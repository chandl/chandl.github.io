---
layout: post
title:  "Machine Learning From Scratch - Part 2 - Support Vector Machines"
date:   2020-05-05 00:00:00 -0700
categories: ml-from-scratch
author: Chandler Severson
image: "/assets/images/blog/ml-svm/svm.png"
description: "In this experiment, I attempt to implement a Support-Vector Machine, a supervised learning model with associated learning algorithms that analyze data used for classification and regression analysis."
---

In this experiment, I attempt to implement a Support-Vector Machine, a supervised learning model that is a popular tool that offers solutions for both machine learning classification and regression problems. The original code and documentation for this article can be found [on my GitHub](https://github.com/chandl/ML-Support-Vector-Machine).

## Overview

This implementation is a Support Vector Machine with Hinge loss and gradient descent; it is being used to find the optimal decision boundary between two classes of data. This implementation is using a pre-defined, small sample of meaningless data. It was used to learn the concepts of SVMs.
...
Here are the results of running this program on our arbitrary data set.

#### Plot of the Rate of Classification Errors During Training

![The rate of classification errors during training](/assets/images/blog/ml-svm/classification-error-rate.png)

#### Plot of the Hyperplane Generated by the SVM

![A plot of the hyperplane generated by the support vector machine](/assets/images/blog/ml-svm/classification-results.png)

### Next Steps

This is part two of a series exploring machine learning algorithms. When part three is released, this page will be updated with the new link!
